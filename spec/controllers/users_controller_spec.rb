...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's mlists" do
      mp1 = Factory(:mlists, :user => @user, :title_id => 1)
      mp2 = Factory(:mlists, :user => @user, :title_id => 2)
      get :show, :id => @user
      response.should have_tag("span.content", mp1.title_id)
      response.should have_tag("span.content", mp2.title_id)
    end
  end
